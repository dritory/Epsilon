...
public class ChunkProviderEpsilon implements IChunkProvider {
    ...
    public ChunkProviderEpsilon(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                if ((var47 += var49) > 0.0D)
                                {
                                    par3ArrayOfByte[var43 += var44] = (byte)GroundGenerationBlock;
                                }
    ...
    public void replaceBlocksForBiome(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        ...
        this.stoneNoise = this.noiseGen4.generateNoiseOctaves(this.stoneNoise, par1 * 16, par2 * 16, 0, 16, 16, 0, var6 * 2.0D, var6 * 2.0D, var6 * 2.0D);
            ...
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var16 = 127; var16 >= 0; --var16)
                {
                    ...
                    else
                    {
                        ...
                        else if (var18 == GroundGenerationBlock)
                        {
                            ...
                            if (var13 == -1)
                            {
                                ...
                                {
                                    var14 = 0;
                                    var15 = (byte)GroundGenerationBlock;
                                }
                                else if (var16 >=var5 && var16 <= var5 + 1)
                                {
